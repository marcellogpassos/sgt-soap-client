...
public class GetDataUltimaVersaoMethod extends DefaultWcfMethod {

    public GetDataUltimaVersaoMethod(String methodNamespace, String methodName, List<PropertyInfo> properties, Class<?> clazz) {
    ...
    protected Object getResult(Class<?> objClass, Object source, String resultName, ExtendedSoapSerializationEnvelope envelope) {
        ...
        java.lang.Object obj = soap.getProperty("return");
