...
public class ArrayOfComplementoMovimentoTO extends Vector<ComplementoMovimentoTO> implements KvmSerializable, HasAttributes {
    ...
    public void loadFromSoap(Object inObj, ExtendedSoapSerializationEnvelope __envelope) {
        ...
        if (inObj instanceof Vector) {
            ...
            for (int i0 = 0; i0 < list.size(); i0++) {
                ...
                if (j != null) {
                    ComplementoMovimentoTO j1 = (ComplementoMovimentoTO) __envelope.get(j, ComplementoMovimentoTO.class, false);
                    add(j1);
                }
            }
        } else {
    ...
    public void getPropertyInfo(int index, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info) {
        info.name = "ComplementoMovimento";
        info.type = ComplementoMovimentoTO.class;
    ...
    public void getAttributeInfo(int index, AttributeInfo info) {
        if (index == 0) {
            ...
            info.setValue("xx2:ArrayOfComplementoMovimento");
        }
        if (index == 1) {
            info.name = "arrayType";
            info.namespace = "http://schemas.xmlsoap.org/soap/encoding/";
            info.setValue("xx1:ComplementoMovimento[]");
        }
        if (index == 2) {
            info.name = "xmlns:xx1";
            info.namespace = "";
    ...
    public boolean equals(Object o) {
        ...
        ArrayOfComplementoMovimentoTO that = (ArrayOfComplementoMovimentoTO) o;
