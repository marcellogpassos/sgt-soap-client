...
public class ArrayOfItemTO extends Vector<ItemTO> implements KvmSerializable, HasAttributes {
    ...
    public void loadFromSoap(Object inObj, ExtendedSoapSerializationEnvelope __envelope) {
        ...
        if (inObj instanceof Vector) {
            ...
            for (int i0 = 0; i0 < list.size(); i0++) {
                ...
                if (j != null) {
                    ItemTO j1 = (ItemTO) __envelope.get(j, ItemTO.class, false);
                    add(j1);
                }
            }
        } else {
    ...
    public boolean equals(Object o) {
        ...
        ArrayOfItemTO items = (ArrayOfItemTO) o;
        return Objects.equals(__source, items.__source);
    }
