...
import br.jus.tjpb.libs.sgtsoapcient.getarrayfilhositem.ArrayOfArvoreGenericaTO;
import br.jus.tjpb.libs.sgtsoapcient.getarrayfilhositem.ArvoreGenericaTO;
import br.jus.tjpb.libs.sgtsoapcient.pesquisaritem.ArrayOfItemTO;
import br.jus.tjpb.libs.sgtsoapcient.pesquisaritem.ItemTO;
...
public class ExtendedSoapSerializationEnvelope extends ExSoapSerializationEnvelope {
    ...
    static {
        classNames.put(SgtSoapClientDefaultProperties.ENDPOINT + "^^Item", ItemTO.class);
        classNames.put(SgtSoapClientDefaultProperties.ENDPOINT + "^^ArvoreGenerica", ArvoreGenericaTO.class);
        classNames.put(SgtSoapClientDefaultProperties.ENDPOINT + "^^ArrayOfItem", ArrayOfItemTO.class);
        classNames.put(SgtSoapClientDefaultProperties.ENDPOINT + "^^ArrayOfArvoreGenerica", ArrayOfArvoreGenericaTO.class);
    }
